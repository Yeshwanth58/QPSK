...
```
# Output Waveform
![image](https://github.com/user-attachments/assets/b9997b5a-7b2b-4eac-bcb8-28ba19cbffdf)

# Results
The binary data was successfully encoded using QPSK modulation. The demodulation process decoded the original message signal from the modulated wave. The output shows the QPSK modulated signal and the demodulated signal matching the input binary data.
